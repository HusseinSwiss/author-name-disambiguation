 ...
 */
public class RDFSStorePeopleSearch {
	/**
     ...
     */
    public RDFSStorePeopleSearch(String hostname, int port, String repositoryID) throws RepositoryException {
    ...
    {
    	ValueFactory f = RDFSStorePeopleSearch.getFactory();
    	URI testedIdURI = f.createURI(Cnst.NAMESPACE_ONTOLOGY_PEOPLE_SEARCH + id);
		// Check if
		String request ="SELECT ?subject WHERE{<"+ testedIdURI +"> ?predicate ?object}";
		TupleQueryResult reponse = RDFSStorePeopleSearch.execSelectQuery(request);
